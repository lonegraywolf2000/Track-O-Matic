...
public class BlastStateChangedEventArgs(List<int> oldValue, List<int> newValue, string? changeReason = null) : ValueChangedEventArgs<List<int>>(oldValue, newValue, changeReason)
{
}

...
/// <summary>
/// Interaction logic for ProgressiveSlam.xaml
/// </summary>
public partial class ProgressiveSlam : UserControl
{
    public ProgressiveSlam()
    {
        InitializeComponent();
        ...
        {
            DataContext = new ProgressiveSlamViewModel(
                itemTrackingService,
